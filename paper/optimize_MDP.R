...
##################################################################################################################
# Set MDP parameters:
param<-FieldReadiness::setParam(weightCompletion=1,weightWorkable=1,weightTraffic=1)
...
policy <- read.csv2("C:/Users/au520279/Documents/FieldReadiness/paper/policyMDP.csv", stringsAsFactors = F)

# Store the policy in the related directory
write.csv2(policy, file ="C:/Users/au520279/Documents/FieldReadiness/paper/Policies/based_weight/policyMDP.csv",row.names=FALSE)
##################################################################################################################
...
# Store the policy in the related directory
write.csv2(policy, file ="C:/Users/au520279/Documents/FieldReadiness/paper/Policies/weight_high_traf/policyMDP.csv",row.names=FALSE)
##################################################################################################################
...
# Store the policy in the related directory
write.csv2(policy, file ="C:/Users/au520279/Documents/FieldReadiness/paper/Policies/weight_high_work/policyMDP.csv",row.names=FALSE)
##################################################################################################################
